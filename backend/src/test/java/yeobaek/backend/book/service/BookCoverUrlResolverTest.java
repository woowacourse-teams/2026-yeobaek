...
class BookCoverUrlResolverTest {
    ...
    void resolvePublicUrl() {
        BookCoverUrlResolver resolver = new BookCoverUrlResolver(
                new S3StorageProperties("bucket", "ap-northeast-2", "https://cover.example///", "yeobaek"));

        assertThat(resolver.resolve("yeobaek/book-covers/123e4567-e89b-12d3-a456-426614174000.jpg"))
