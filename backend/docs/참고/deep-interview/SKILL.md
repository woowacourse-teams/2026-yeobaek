# 개발동생 deep-interview 원문 스냅샷

- 출처: https://github.com/devbrother2024/skills
- 원문 경로: `deep-interview/SKILL.md`
- 라이선스: MIT
- 수집 날짜: 2026-08-18
- 제공 방식: 개발자가 대화에서 제공한 문서 전문

아래 내용은 프로젝트 오버라이드를 섞지 않은 제공 원문이다. 실제 프로젝트 동작은
[deep-interview 활용 지침](../../지침/프로세스/deep-interview_활용.md)을 함께 적용한다.
